...
def build_index_md(groups):
    ...
    parts.append(
        "See: `docs/templates/scoring/RejectLog.template.md` and the Reject "
        "section in `output/asset_scores.md` for rule triggers and reasons.\n\n"
    )
    parts.append(
        f"_Generated by the FTH Liquidity Engine on: {now}.  This is a "
        "planning tool, not an offering document. All transactions remain "
        "subject to legal, compliance, and counterparty approvals._\n"
    )
